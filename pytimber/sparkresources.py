...
class SparkResources(Enum):
    ...
    def properties(self):
        ...
        self._props['spark.yarn.appMasterEnv.JAVA_HOME'] = "/var/nxcals/jdk1.8.0_121"
        self._props['park.executorEnv.JAVA_HOME'] = "/var/nxcals/jdk1.8.0_121"

        self._props['spark.yarn.jars'] = "hdfs:////project/nxcals/lib/spark-2.4.0/*.jar"
        self._props['spark.yarn.am.extraLibraryPath'] = "/usr/lib/hadoop/lib/native"
        self._props['spark.executor.extraLibraryPath'] = "/usr/lib/hadoop/lib/native"

        self._props['spark.yarn.historyServer.address'] = "ithdp1001.cern.ch:18080"
